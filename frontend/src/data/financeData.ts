...
export const financeStudents: FinanceStudent[] = [
  { id:'fs01',name:'Selam Alemayehu',studentId:'HC-2024-8832',avatar:'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80',email:'selam.a@harmony.edu',phone:'+251 911 200 001',programId:'p01',programName:'Theatrical Art & Filmmaking',departmentId:'d01',departmentName:'Photography & Visual Media',year:4,semester:'Fall 2024',tuition:15_000,adminFees:1_200,labFees:800,libraryFines:0,otherCharges:0,scholarshipDiscount:3_000,totalCharged:14_000,totalPaid:14_000,outstanding:0,paymentStatus:'Paid',riskLevel:'Low',daysOverdue:0,lastPaymentDate:'2024-09-05',installmentPlan:false },
  { id:'fs02',name:'Biruk Teshome',studentId:'HC-2023-7641',avatar:'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80',email:'biruk.t@harmony.edu',phone:'+251 911 200 002',programId:'p01',programName:'Theatrical Art & Filmmaking',departmentId:'d01',departmentName:'Photography & Visual Media',year:3,semester:'Fall 2024',tuition:15_000,adminFees:1_200,labFees:800,libraryFines:150,otherCharges:0,scholarshipDiscount:0,totalCharged:17_150,totalPaid:10_000,outstanding:7_150,paymentStatus:'Partial',riskLevel:'Medium',daysOverdue:18,lastPaymentDate:'2024-09-20',installmentPlan:true },
  { id:'fs03',name:'Hana Wolde',studentId:'HC-2024-9001',avatar:'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=300&q=80',email:'hana.w@harmony.edu',phone:'+251 911 200 003',programId:'p02',programName:'Journalism',departmentId:'d01',departmentName:'Photography & Visual Media',year:2,semester:'Fall 2024',tuition:14_500,adminFees:1_200,labFees:600,libraryFines:0,otherCharges:0,scholarshipDiscount:0,totalCharged:16_300,totalPaid:16_300,outstanding:0,paymentStatus:'Paid',riskLevel:'Low',daysOverdue:0,lastPaymentDate:'2024-09-02',installmentPlan:false },
  { id:'fs04',name:'Yonas Kebede',studentId:'HC-2022-5520',avatar:'https://images.unsplash.com/photo-1463453091185-61582044d556?auto=format&fit=crop&w=300&q=80',email:'yonas.k@harmony.edu',phone:'+251 911 200 004',programId:'p03',programName:'Information Technology \(IT\)',departmentId:'d02',departmentName:'Business Administration',year:4,semester:'Fall 2024',tuition:15_000,adminFees:1_200,labFees:0,libraryFines:500,otherCharges:300,scholarshipDiscount:0,totalCharged:17_000,totalPaid:4_500,outstanding:12_500,paymentStatus:'Overdue',riskLevel:'Critical',daysOverdue:45,lastPaymentDate:'2024-08-10',installmentPlan:false,notes:'Repeated late payment. Sent 3 reminders.' },
  { id:'fs05',name:'Liya Girma',studentId:'HC-2025-1122',avatar:'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=300&q=80',email:'liya.g@harmony.edu',phone:'+251 911 200 005',programId:'p05',programName:'Information Technology \(IT\)',departmentId:'d03',departmentName:'Information Technology',year:1,semester:'Fall 2024',tuition:16_000,adminFees:1_500,labFees:1_200,libraryFines:0,otherCharges:0,scholarshipDiscount:2_000,totalCharged:16_700,totalPaid:16_700,outstanding:0,paymentStatus:'Paid',riskLevel:'Low',daysOverdue:0,lastPaymentDate:'2024-09-01',installmentPlan:false },
  { id:'fs06',name:'Dawit Mekonnen',studentId:'HC-2023-7200',avatar:'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=300&q=80',email:'dawit.m@harmony.edu',phone:'+251 911 200 006',programId:'p05',programName:'Information Technology \(IT\)',departmentId:'d03',departmentName:'Information Technology',year:3,semester:'Fall 2024',tuition:16_000,adminFees:1_500,labFees:1_200,libraryFines:200,otherCharges:0,scholarshipDiscount:0,totalCharged:18_900,totalPaid:9_450,outstanding:9_450,paymentStatus:'Partial',riskLevel:'High',daysOverdue:30,lastPaymentDate:'2024-09-15',installmentPlan:true },
  ...
  { id:'fs10',name:'Abel Tesfaye',studentId:'HC-2025-1340',avatar:'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80',email:'abel.t@harmony.edu',phone:'+251 911 200 010',programId:'p06',programName:'BSc Photography & Videography',departmentId:'d03',departmentName:'Information Technology',year:1,semester:'Fall 2024',tuition:16_000,adminFees:1_500,labFees:1_200,libraryFines:0,otherCharges:0,scholarshipDiscount:0,totalCharged:18_700,totalPaid:18_700,outstanding:0,paymentStatus:'Paid',riskLevel:'Low',daysOverdue:0,lastPaymentDate:'2024-09-04',installmentPlan:false },
  ...
  { id:'fs13',name:'Tigist Worku',studentId:'HC-2023-7388',avatar:'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&w=300&q=80',email:'tigist.w@harmony.edu',phone:'+251 911 200 013',programId:'p03',programName:'Information Technology \(IT\)',departmentId:'d02',departmentName:'Business Administration',year:3,semester:'Fall 2024',tuition:15_000,adminFees:1_200,labFees:0,libraryFines:100,otherCharges:0,scholarshipDiscount:1_500,totalCharged:14_800,totalPaid:14_800,outstanding:0,paymentStatus:'Paid',riskLevel:'Low',daysOverdue:0,lastPaymentDate:'2024-09-10',installmentPlan:false },
  ...
  { id:'fs17',name:'Mahlet Tafesse',studentId:'HC-2024-8400',avatar:'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=300&q=80',email:'mahlet.t@harmony.edu',phone:'+251 911 200 017',programId:'p01',programName:'Theatrical Art & Filmmaking',departmentId:'d01',departmentName:'Photography & Visual Media',year:2,semester:'Fall 2024',tuition:15_000,adminFees:1_200,labFees:800,libraryFines:0,otherCharges:0,scholarshipDiscount:0,totalCharged:17_000,totalPaid:17_000,outstanding:0,paymentStatus:'Paid',riskLevel:'Low',daysOverdue:0,lastPaymentDate:'2024-09-12',installmentPlan:false },
  { id:'fs18',name:'Naol Bekele',studentId:'HC-2025-1500',avatar:'https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&fit=crop&w=300&q=80',email:'naol.b@harmony.edu',phone:'+251 911 200 018',programId:'p06',programName:'BSc Photography & Videography',departmentId:'d03',departmentName:'Information Technology',year:1,semester:'Fall 2024',tuition:16_000,adminFees:1_500,labFees:1_200,libraryFines:0,otherCharges:0,scholarshipDiscount:2_500,totalCharged:16_200,totalPaid:8_100,outstanding:8_100,paymentStatus:'Partial',riskLevel:'Medium',daysOverdue:8,lastPaymentDate:'2024-10-05',installmentPlan:true },
...
export const transactions: Transaction[] = [
  makeTxn('tx001','fs01','Selam Alemayehu','Theatrical Art & Filmmaking','Tuition','Semester tuition — Fall 2024',12_000,'Bank Transfer','BT-HC-10001','rc001','fin01','Ato Kebede Worku','2024-09-05','09:14'),
  makeTxn('tx002','fs01','Selam Alemayehu','Theatrical Art & Filmmaking','Fee','Administrative & lab fees',2_000,'Cash','CASH-10002','rc002','fin01','Ato Kebede Worku','2024-09-05','09:22'),
  makeTxn('tx003','fs01','Selam Alemayehu','Theatrical Art & Filmmaking','Scholarship','Merit scholarship credit',-3_000,'Bank Transfer','SCH-10001',null,'fin01','Ato Kebede Worku','2024-09-04','11:00'),
  makeTxn('tx004','fs02','Biruk Teshome','Theatrical Art & Filmmaking','Tuition','First installment — Fall 2024',6_000,'Telebirr','TLB-20041','rc003','fin01','Ato Kebede Worku','2024-09-20','14:05'),
  makeTxn('tx005','fs02','Biruk Teshome','Theatrical Art & Filmmaking','Tuition','Second installment',4_000,'Telebirr','TLB-20088','rc004','fin01','Ato Kebede Worku','2024-10-10','10:30'),
  makeTxn('tx006','fs02','Biruk Teshome','Theatrical Art & Filmmaking','Fine','Library fine — overdue books',150,'Cash','CASH-10050',null,'fin01','Ato Kebede Worku','2024-09-18','16:00'),
  makeTxn('tx007','fs03','Hana Wolde','Journalism','Tuition','Full tuition — Fall 2024',14_500,'Chapa','CHP-30011','rc005','fin02','W/t Meron Alemu','2024-09-02','08:45'),
  makeTxn('tx008','fs03','Hana Wolde','Journalism','Fee','Administrative fees',1_200,'Chapa','CHP-30012','rc006','fin02','W/t Meron Alemu','2024-09-02','08:50'),
  makeTxn('tx009','fs03','Hana Wolde','Journalism','Fee','Lab fees',600,'Chapa','CHP-30013','rc007','fin02','W/t Meron Alemu','2024-09-02','08:55'),
  makeTxn('tx010','fs04','Yonas Kebede','Information Technology \(IT\)','Tuition','Partial tuition payment',4_000,'Cash','CASH-10099','rc008','fin01','Ato Kebede Worku','2024-08-10','11:20'),
  makeTxn('tx011','fs04','Yonas Kebede','Information Technology \(IT\)','Fine','Library fines',500,'Cash','CASH-10100',null,'fin01','Ato Kebede Worku','2024-09-01','15:30'),
  makeTxn('tx012','fs04','Yonas Kebede','Information Technology \(IT\)','Fee','Miscellaneous charges',300,'Cash','CASH-10101',null,'fin01','Ato Kebede Worku','2024-09-01','15:35'),
  makeTxn('tx013','fs05','Liya Girma','Information Technology \(IT\)','Tuition','Full tuition — Fall 2024',16_000,'Bank Transfer','BT-HC-10020','rc009','fin02','W/t Meron Alemu','2024-09-01','10:00'),
  makeTxn('tx014','fs05','Liya Girma','Information Technology \(IT\)','Fee','Administrative & lab fees',2_700,'Bank Transfer','BT-HC-10021','rc010','fin02','W/t Meron Alemu','2024-09-01','10:05'),
  makeTxn('tx015','fs05','Liya Girma','Information Technology \(IT\)','Scholarship','Need-based scholarship',-2_000,'Bank Transfer','SCH-10005',null,'fin02','W/t Meron Alemu','2024-08-31','14:00'),
  makeTxn('tx016','fs06','Dawit Mekonnen','Information Technology \(IT\)','Tuition','First installment',9_450,'Telebirr','TLB-20110','rc011','fin01','Ato Kebede Worku','2024-09-15','09:30'),
  makeTxn('tx017','fs06','Dawit Mekonnen','Information Technology \(IT\)','Fine','Library fine',200,'Cash','CASH-10120',null,'fin01','Ato Kebede Worku','2024-09-14','16:10'),
  ...
  makeTxn('tx025','fs10','Abel Tesfaye','BSc Photography & Videography','Tuition','Full tuition — Fall 2024',16_000,'Bank Transfer','BT-HC-10055','rc017','fin01','Ato Kebede Worku','2024-09-04','09:00'),
  makeTxn('tx026','fs10','Abel Tesfaye','BSc Photography & Videography','Fee','Admin + lab fees',2_700,'Bank Transfer','BT-HC-10056','rc018','fin01','Ato Kebede Worku','2024-09-04','09:05'),
  ...
  makeTxn('tx029','fs13','Tigist Worku','Information Technology \(IT\)','Tuition','Tuition — Fall 2024',13_300,'Chapa','CHP-30080','rc021','fin02','W/t Meron Alemu','2024-09-10','14:00'),
  makeTxn('tx030','fs13','Tigist Worku','Information Technology \(IT\)','Fine','Library fine',100,'Cash','CASH-10150',null,'fin02','W/t Meron Alemu','2024-09-09','11:00'),
  makeTxn('tx031','fs13','Tigist Worku','Information Technology \(IT\)','Scholarship','Merit discount',-1_500,'Bank Transfer','SCH-10015',null,'fin02','W/t Meron Alemu','2024-09-08','14:00'),
  ...
  makeTxn('tx036','fs17','Mahlet Tafesse','Theatrical Art & Filmmaking','Tuition','Full tuition',15_000,'Chapa','CHP-30100','rc025','fin02','W/t Meron Alemu','2024-09-12','11:00'),
  makeTxn('tx037','fs17','Mahlet Tafesse','Theatrical Art & Filmmaking','Fee','Admin + lab fees',2_000,'Chapa','CHP-30101','rc026','fin02','W/t Meron Alemu','2024-09-12','11:05'),
  makeTxn('tx038','fs18','Naol Bekele','BSc Photography & Videography','Tuition','First installment',8_100,'Bank Transfer','BT-HC-10080','rc027','fin01','Ato Kebede Worku','2024-10-05','10:00'),
  makeTxn('tx039','fs18','Naol Bekele','BSc Photography & Videography','Scholarship','Partial scholarship',-2_500,'Bank Transfer','SCH-10025',null,'fin01','Ato Kebede Worku','2024-10-04','14:00'),
