...
export const AdminSearchModal: React.FC<AdminSearchModalProps> = ({ isOpen, onClose, onNavigate }) => {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-start justify-center pt-[12vh] px-4" onClick={onClose}>
          <motion.div
          ...
          >
            <div className="flex items-center gap-3 px-4 py-3.5 border-b border-white/10">
              ...
              <input ref={inputRef} type="text" value={query} onChange={e => setQuery(e.target.value)}
                ...
                className="flex-1 bg-transparent font-sans text-sm text-white placeholder:text-white/30 outline-none" aria-label="Global admin search" />
