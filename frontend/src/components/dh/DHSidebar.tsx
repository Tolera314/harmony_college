  ...
  return (
    ...
    >
      ...
      <div className="mb-8 px-2">
        <button onClick={() => setActiveTab('overview')} className="flex items-center gap-3 text-left group focus:outline-none ds-focus-ring rounded-xl">
          ...
          <div className="hidden xl:block">
            ...
            <span className="text-[10px] font-mono uppercase tracking-widest font-bold block mt-1" style={{ color: 'var(--brand-gold)' }}>Dept. Head</span>
          </div>
        </button>
