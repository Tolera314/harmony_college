...
async function seedStudentDashboardData(): Promise<void> {
  ...
  for (const sr of studentRecords) {
    ...
    // ── Attendance sessions per enrollment ───────────────────────────────────
    // NOTE: Assignments and quizzes are created ONLY by real instructors via the
    // Instructor Dashboard — never auto-generated here.
